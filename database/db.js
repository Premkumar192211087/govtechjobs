...
function seedData() {
  ...
  memoryStore.jobs = [
    ...
    },
    {
      ...
      status: 'active',
      apply_link: 'https://apply.isro.gov.in',
      portal_url: 'https://isro.gov.in',
      notification_pdf_url: 'https://isro.gov.in/careers/icrb2026.pdf',
    ...
    },
    {
      ...
      status: 'active',
      apply_link: 'https://nic.in/careers/apply',
      portal_url: 'https://nic.in',
      notification_pdf_url: 'https://nic.in/careers/scientistb2026.pdf',
    ...
    },
    {
      ...
      status: 'active',
      apply_link: 'https://ibps.in/apply-online',
      portal_url: 'https://ibps.in',
      notification_pdf_url: 'https://ibps.in/crp-so-2026.pdf',
    ...
    },
    {
      ...
      portal_url: 'https://ecil.co.in',
      notification_pdf_url: 'https://ecil.co.in/get2026.pdf',
    ...
    },
    {
      ...
      status: 'active',
      apply_link: 'https://nielit.gov.in/apply',
      portal_url: 'https://nielit.gov.in',
      notification_pdf_url: 'https://nielit.gov.in/scientistb2026.pdf',
    ...
    },
    {
      ...
      exam_date: futureDate(60),
      status: 'active',
      apply_link: 'https://rrbcdg.gov.in/en/apply',
      portal_url: 'https://rrbcdg.gov.in',
      notification_pdf_url: 'https://rrbcdg.gov.in/ntpc2026.pdf',
    ...
    },
    {
      ...
      exam_date: null,
      status: 'active',
      apply_link: 'https://powergrid.in/careers',
      portal_url: 'https://powergrid.in',
      notification_pdf_url: 'https://powergrid.in/et2026.pdf',
    ...
    },
    {
      ...
      exam_date: futureDate(60),
      status: 'active',
      apply_link: 'https://railtelindia.com/careers',
      portal_url: 'https://railtelindia.com',
      notification_pdf_url: 'https://railtelindia.com/manager2026.pdf',
    ...
    },
    {
      ...
      status: 'active',
      apply_link: 'https://stpi.in/careers',
      portal_url: 'https://stpi.in',
      notification_pdf_url: 'https://stpi.in/mts2026.pdf',
    ...
    },
    {
      ...
      notification_pdf_url: 'https://ugcnet.nta.ac.in/dec2026.pdf',
    ...
    },
    {
      ...
      exam_date: null,
      status: 'active',
      apply_link: 'https://joinindiannavy.gov.in/apply',
      portal_url: 'https://joinindiannavy.gov.in',
      notification_pdf_url: 'https://joinindiannavy.gov.in/ssc-it-2026.pdf',
